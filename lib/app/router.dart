...
import '../features/games/clasificaton/presentation/level_intro_page.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/clasificaton/intro',
      builder: (context, state) => const LevelIntroPage(
        level: 1,
        imagePath: 'assets/images/clasificaton/covers/portada_nivel_1.jpeg',
      ),
    ),
