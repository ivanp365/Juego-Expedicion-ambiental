...
_Last synced: 2026-07-22T02:57:54.406Z._
...
- `c:\Users\pardo\Documents\expedicion_ambiental\.mcp.json` _(workspace: expedicion_ambiental)_ — _file missing_
...
- **skill-creator** — `C:\Users\pardo\.agents\skills\skill-creator` — Create new skills, modify and improve existing skills. Use when users want to create a skill from scratch, edit, or optimize an existing skill.
