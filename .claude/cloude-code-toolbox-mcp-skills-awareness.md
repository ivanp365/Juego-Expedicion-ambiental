...
_Generated: 2026-07-12T05:09:48.571Z_
...
Workspace `mcp.json` _(folder: expedicion_ambiental)_

- **c:\Users\pardo\Documents\expedicion_ambiental\.mcp.json** — _File missing_
...
- **skill-creator** — `C:\Users\pardo\.agents\skills\skill-creator`
  - Create new skills, modify and improve existing skills. Use when users want to create a skill from scratch, edit, or optimize an existing skill.
